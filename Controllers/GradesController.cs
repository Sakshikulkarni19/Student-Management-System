...
namespace student_Management.Controllers
{
    public class GradesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "grade_id,enrollment_id,grade1")] Grade grade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "grade_id,enrollment_id,grade1")] Grade grade)
        {
            if (ModelState.IsValid)
            {
